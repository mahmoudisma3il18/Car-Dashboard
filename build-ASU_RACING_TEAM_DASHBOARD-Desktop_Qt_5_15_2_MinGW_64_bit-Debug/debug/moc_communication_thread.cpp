/****************************************************************************
** Meta object code from reading C++ file 'communication_thread.h'
**
...
#error "The header file 'communication_thread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 37, 7) // "timeout"
    ...
    "CommunicationThread\0message\0\0s\0error\0"
    "timeout"
};
...
void CommunicationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CommunicationThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CommunicationThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::message)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CommunicationThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::error)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CommunicationThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::timeout)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CommunicationThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_CommunicationThread.data,
    qt_meta_data_CommunicationThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CommunicationThread::message(const QString & _t1)
{
...
// SIGNAL 1
void CommunicationThread::error(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void CommunicationThread::timeout(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
